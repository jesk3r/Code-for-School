    ...
    while running:
        ...
        try:
            ...
            for i in range(1, 7):
                ...
                rotated_image, rect = rotate(surface=Player.main_image, angle=- pdata[i - 1][str(n)]["angle"] + 90,pivot=pdata[i - 1][str(n)]["pos"], offset=Player.offset)
